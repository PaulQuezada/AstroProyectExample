                ...
                <div className="space-y-3">
                    <Skeleton isLoaded={isLoaded} className="w-3/5 rounded-lg">
                        <div className="h-3 w-full rounded-lg bg-secondary">
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eveniet amet tenetur rem voluptatem cumque dignissimos magnam distinctio illum odit? Odio soluta debitis blanditiis expedita voluptas saepe accusamus? Nostrum, sunt eius?</p>
                        </div>
                    </Skeleton>
